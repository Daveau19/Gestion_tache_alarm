...
public class MainActivity extends AppCompatActivity {
    ...
    public void loginUser(String user,String pass){
        ...
        if(temp==null){
            Toast.makeText(MainActivity.this,"Nom utlisateur invalide",Toast.LENGTH_SHORT).show();
        }
        else{
            if(temp.getPassword().equals(pass)){
                ...
                Toast.makeText(MainActivity.this,"Password invalide",Toast.LENGTH_SHORT).show();
            }
        }
