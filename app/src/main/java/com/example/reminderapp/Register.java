...
public class Register extends AppCompatActivity {
    ...
    public void registerUser(String user,String pass){
        ...
        if(temp2==null) {
            roomDAO.Insert(temp);
            Toast.makeText(Register.this,"Enregistre avec succes",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Register.this,"Utilisateur deja enregistre",Toast.LENGTH_SHORT).show();
